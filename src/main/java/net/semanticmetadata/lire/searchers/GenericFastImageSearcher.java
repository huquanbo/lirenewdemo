            ...
            try {
                ...
                for (int i = 0; i < docs; i++) {
                    ...
                    if (!(reader.hasDeletions() && !liveDocs.get(i))) {
                        d = reader.document(i);
                        IndexableField  indexableField=d.getField(fieldName);//2015年8月11日，检测indexableField是否为空
...
//        }
    ...
    public ImageSearchHits search(BufferedImage image, IndexReader reader) throws IOException {
        ...
        if (extractorItem.isGlobal()){
            ...
            if(localFeatureExtractor.getFeatures()!=null){//modify,2015-07-29,检测是否含有相关特征
